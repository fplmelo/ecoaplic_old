...
## A perda das variedades
]

<img src=libs/ark.png width = 350>
<img src=libs/myers.jpeg width = 350>

# Norman Myers (1934-2019)

---
# Níveis de diversidade
#![:col_header Genes, Especies, Ecossistemas]

###![:col_row Diversidade intra-específica, Diversidade inter-específica, Diversidade intra/inter-ecossistêmica]
###![:col_row Potencial evolutivo, Funções ecológicas, Ciclos biogeoquímicos]
###![:col_row <img src= libs/maiz.jpg width = 250>, <img src= libs/butter.jpg width = 250>,<img src= libs/landscape.jpg width = 250>]
...
.pull-left[
<img src=libs/bees.png width = 250>
...
- ### Segundo a [Enciclopédia da Biodiversidade](https://www.sciencedirect.com/topics/agricultural-and-biological-sciences/functional-diversity)
  - ###"Refere-se aos componentes da biodiversidade que influenciam *como* um ecossistema funciona"
.center[
...
.pull-right[
- ### Quanto mais diversidade é possível encontrar?
- ### Em que níveis?
...
# Ok, muita diversidade mas... qual é a sua importância?
...
- ### Tem grande poder de informação acerca de processos de montagem das comunidades biológicas
