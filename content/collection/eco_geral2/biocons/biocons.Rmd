...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan(url ="https://ecoaplic.org/slides_aulas/eco_geral2/aula4_biocons.html#1", ratio = "16:9")
...
<iframe width="680" height="400" src="https://www.youtube.com/embed/IrfLtP9C6K8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1. A turma será dividida em dois grups. 

1. O primeiro fará uma apresnetação breve sobre o modelo de unidades de conservação do Brasil, seus tipos, como são criados e seus objetivos

1. O segundo grupo vai fazer uma crítica ao modelo brasieiro de Unidades de Conservação, destacando suas falhas mas també acertos.

1. Finalmente vamos tentar fazer uma discussão geral sobre os rumos da política brasileria sobre áreas protegidas. 

1. Essa será nossa última tarefa e aula final!
