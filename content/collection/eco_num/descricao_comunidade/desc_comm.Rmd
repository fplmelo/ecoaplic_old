...
## Exercíico Comunidades Culinárias
...
```{r}
# lembrem que para criar um 'chunk' como esse é só usar o comando "ctrl+alt+i"
base<-read.csv("content/collection/eco_num/com_cul.csv", row.names = 1) # atenção, use o caminho onde você guardou a base que baixou anteriormente
...
# mchequem as bases com o comando abaixo
base_q
base_t
